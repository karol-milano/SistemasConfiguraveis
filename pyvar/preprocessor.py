...
class Preprocessor:
    ...
    def parse_save(self, in_file, out_file, commit, data, autor, file_name):
        """
            ...
            for line in input_file:
                ...
                if found != 0:
                    ...
                    csv_buffer.append({
                        ...
                        "Data": data,
                        "Autor": autor,
                        "Arquivo": file_name.split(commit + "/")[1],
                        "Mudança por arquivo": line[0],
                        "Variabilidade": var,
                        "Mudança por variabilidade": line[0]
                    })
