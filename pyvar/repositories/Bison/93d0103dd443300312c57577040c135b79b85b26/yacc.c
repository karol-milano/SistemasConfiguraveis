...
@@ -145,6 +145,68 @@ m4_define([b4_rhs_location],
 [(yylsp@{($2) - ($1)@})])
...
@@ -171,14 +233,14 @@ b4_copyright([Skeleton implementation for Bison's Yacc-like parsers in C],
 ]b4_identification
...
@@ -1005,85 +1067,22 @@ yysyntax_error (char *yyresult, int yystate, int yychar)
...
+  {]b4_declare_parser_state_variables[
     /* Used to determine if this is the first time this instance has
        been used.  */
     int yynew;
@@ -1155,44 +1154,53 @@ b4_c_function_def([[yyparse]], [[int]], b4_parse_param)[
